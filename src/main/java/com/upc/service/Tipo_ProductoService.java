...
public interface Tipo_ProductoService {
    ...
    public abstract Tipo_Producto getTipo_Producto(Number CTipo_Producto);

    public abstract List<Tipo_Producto> getTipo_Productos();

    public abstract void deleteTipo_Producto(Number CTipo_Producto);

    public abstract boolean isTipo_ProductoExist(Number CTipo_Producto);
}
